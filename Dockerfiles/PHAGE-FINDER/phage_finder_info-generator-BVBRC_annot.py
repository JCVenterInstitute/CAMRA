...
<<<<<<< HEAD
<<<<<<< HEAD
parser.add_argument('output_location', help="Path to store phage_finder_info.txt.")
=======
parser.add_argument('output_location', default='.', help="Path to store phage_finder_info.txt.")
>>>>>>> f8acdc0 (finished python script that transforms BVBRC annotation outputs to input needed for phage_finder)
=======
parser.add_argument('output_location', help="Path to store phage_finder_info.txt.")
>>>>>>> 0f40e11 (minor changes)
...
=======
print(f">>> FINISHED, file stored {output_loc}")
>>>>>>> f8acdc0 (finished python script that transforms BVBRC annotation outputs to input needed for phage_finder)
=======
print(f">>> FINISHED, file stored here: {output_loc}")
>>>>>>> 0f40e11 (minor changes)
